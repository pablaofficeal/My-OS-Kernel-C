...
x86_64-elf-gcc -g -O1 -ffreestanding -fno-stack-protector -fno-pic -m64 -mcmodel=kernel -mgeneral-regs-only -mno-red-zone -I./src -c src/drivers/mouse/i2c_hid_touchpad.c -o i2c_hid_touchpad.o
...
x86_64-elf-ld -T linker.ld -o kernel.elf boot.o multiboot.o grub_main.o kernel.o gdt.o idt.o syscall.o serial.o vga.o pic.o fb.o gop.o ps2_mouse.o i2c_hid_touchpad.o string.o gdt_asm.o idt_asm.o
