...
echo "🔗 Linking kernel..."
# Добавляем флаг -nographic чтобы убрать RWX warning
ld -m elf_i386 -nographic -T linker.ld -o kernel.bin kernel.o screen.o keyboard.o string.o shell.o commands.o disk.o fat16.o
