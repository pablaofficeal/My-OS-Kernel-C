...
x86_64-elf-gcc -g -O1 -ffreestanding -fno-stack-protector -fno-pic -m64 -mcmodel=small -mno-red-zone -mgeneral-regs-only -I./src -c src/programs/installer/progress.c -o installer_progress.o
...
x86_64-elf-ld -T linker-userspace.ld -o installer installer_program.o installer_progress.o terminal_window.o libpuregui.a libpurec.a
