...
x86_64-elf-gcc -g -O1 -ffreestanding -fno-stack-protector -fno-pic -m64 -mcmodel=kernel -mgeneral-regs-only -mno-red-zone -I./src -c src/drivers/mouse/i2c_hid_touchpad.c -o i2c_hid_touchpad_limine.o
...
x86_64-elf-ld -T linker-limine.ld -o kernel-limine.elf boot_limine.o kernel_limine.o gdt_limine.o idt_limine.o syscall_limine.o serial_limine.o vga_limine.o pic_limine.o fb_limine.o gop_limine.o ps2_mouse_limine.o i2c_hid_touchpad_limine.o string_limine.o gdt_asm_limine.o idt_asm_limine.o
